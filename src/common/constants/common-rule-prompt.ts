export const COMMON_RULE_PROMPT = [
  ...
  "- YOU MUST OUTPUT WITH NON-HUMAN MESSAGE AND NOT A SINGLE EXPLAINATION.",
  "- ENSURE YOUR ANSWER IS UNBIASED AND AVOIDS RELYING ON STEREOTYPES.",
  "- AVOID OUTPUT BAD CONTROL CHARACTERS OF JSON IN THE OUTPUT STRING!!!",
];

export const COMMON_RULE_WITH_JSON_PROMPT = [
  ...COMMON_RULE_PROMPT,
  "- YOU MUST OBEY AND FOLLOW THE RESPONSE FORMAT.",
];
